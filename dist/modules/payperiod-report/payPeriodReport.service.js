...
exports.generatePayPeriodSummary = generatePayPeriodSummary;
 ...
 */
async function generatePayPeriodSummary(organizationId, employeeId, refDate) {
    ...
    const { startDate, endDate } = (0, payperiod_service_1.computePayPeriod)(org, refDate);
